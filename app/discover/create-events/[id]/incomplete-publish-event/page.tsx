...
export default function PublishEvent(): JSX.Element {
  ...
  return (
    <React.Fragment>
        ...
        <section>
          {getUserEvent?.isLoading ? (
            ...
            <div className="hidden min-[900px]:flex gap-10 md:flex-row">
              ...
              <div className="font-BricolageGrotesqueRegular flex-1 h-fit my-auto border-l border-black px-6" style={{ minWidth: "40%" }}>
                <div className="py-8">
      ...
      {isModalOpen && (
        <CantPublish open={isModalOpen} onClose={() => setIsModalOpen(false)} />
      )}
    </React.Fragment>
  );
}
