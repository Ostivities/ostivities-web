...
const options = [
  {
    background:
      "url(https://res.cloudinary.com/ddgehpmnq/image/upload/v1724391173/Rectangle_34624138_wjlfuk.png)",
    main: "Events",
  },
  {
    background:
  ...
  {
    background:
      "url(https://res.cloudinary.com/ddgehpmnq/image/upload/v1724391182/Rectangle_34624145_pdhqhv.png)",
    main: "Concerts",
  },
  {
    background:
  ...
  {
    background:
      "url(https://res.cloudinary.com/ddgehpmnq/image/upload/v1724391169/Rectangle_34624137_r5mxr7.png)",
    main: "Conferences",
  },
  {
    background:
      "url(https://res.cloudinary.com/ddgehpmnq/image/upload/v1724391169/Rectangle_34624135_qhgim4.png)",
    main: "Theater Performances",
  },
  {
    background:
      "url(https://res.cloudinary.com/ddgehpmnq/image/upload/v1724391171/Rectangle_34624141_k0nx25.png)",
    main: "Birthdays",
  },
  {
    background:
      "url(https://res.cloudinary.com/ddgehpmnq/image/upload/v1724391170/Rectangle_34624143_btbrzb.png)",
    main: "Hackathons",
  },
  {
    background:
      "url(https://res.cloudinary.com/ddgehpmnq/image/upload/v1724391172/Rectangle_34624144_q5zagu.png)",
...
function ComingSoon(): JSX.Element | null {
  ...
  useEffect(() => {
    const updateMedia = () => setIsDesktop(window.innerWidth >= 1000);
        ...
        {options.map((option, index) => (
          <div
            ...
            className={`relative overflow-hidden min-w-[60px] m-2 cursor-pointer transition-all duration-500 ease-[cubic-bezier(0.05,0.61,0.41,0.95)] ${
              index === activeIndex
                ? "flex-grow-[10000] max-w-[600px] m-0 rounded-[30px]"
                : "flex-grow rounded-[20px]"
            }`}
            style={{
